...
const columns = [
  ...
  { id: "CATEGROYNAME", label: "CATEGROYNAME", minWidth: 40 },
...
const HomeSlides = () => {
  ...
  const deleteSlide = (id) => {
    deleteData(`/api/categroy/${id}`).then((res) => {
      if (res?.error === false) {
        getData();
      }
    });
  ...
  return (
    <div className="w-full py-3 px-5">
      <div className="flex items-center justify-between">
        ...
        <Link href={"/categroy-list/add-categroy"}>
          <Button
            size="small"
            sx={{
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          <Link
                            href={`/categroy-list/${cat?._id}`} //edit-slide?slide=
                          >
