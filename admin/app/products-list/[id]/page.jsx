...
import { deleteImage, fetchDatafromApi, editData } from "@/app/utils/api";
    ...
    fetchDatafromApi(`/api/product/${id}`).then((res) => {
      if (res?.product) {
        ...
        setFormFields({
          ...
          catId: prod.catId || "",
          categroy: prod.categroy?._id || prod.categroy || "",
          stock: prod.stock || "",
          rating: prod.rating || "",
          isFeatured: prod.isFeatured !== undefined ? prod.isFeatured : "",
          discount: prod.discount || "",
        });
        setPreview(prod.images || []);
        setCategroyVal(prod.catId || "");
        setIsFeatureVal(prod.isFeatured !== undefined ? prod.isFeatured : "");
        setValue(prod.rating || 1);
      }
    });
  };
        ...
        <form className="mt-5" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-4 gap-5">
            <div className="col flex flex-col gap-1">
              <span className="text-[15px] text-gray-800">Category</span>
              <Select
                value={categroyVal}
